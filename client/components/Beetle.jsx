...
useGLTF.preload('../assets/Beetle.glb')
...
const Beetle = forwardRef(({ args = [1.7, 1, 4], mass = 500, ...props }, ref) => {
  const { nodes, materials } = useGLTF('../assets/Beetle.glb')
  const [, api] = useBox(() => ({ mass, args, allowSleep: false, onCollide: (e) => {console.log('bonk', e.body)}, ...props }), ref)
  return (
